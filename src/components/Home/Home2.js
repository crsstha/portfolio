        ...
        <Row>
          <Col md={8} className="home-about-description">
            ...
            <p className="home-about-body">
              I’m passionate about all things programming 💻 and love diving
              deep into code! 🤿 From building sleek, responsive web apps 📱💻
              to tackling complex backend systems 🛠️🔧, I enjoy every bit of the
              journey! 🌐
              <br />
              <br /> My areas of expertise include web technologies 🌍 and
              development 🚀, with a keen interest in exploring the exciting
              world of <b className="purple">AI.</b>🤖✨.
              <br />
              <br /> 💻 I’ve worked on developing awesome products using
